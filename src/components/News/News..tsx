        ...
        <div className={cx('news')}>
            <div className={cx('newsBackground')}>
                ...
                <div className={cx('newsBackground__img')}>
                    <img className={cx('newsBackground__img__hime')} src={data.imgSrc.NEWS_HIME} alt="" loading="lazy" />
                    <img className={cx('newsBackground__img__yuzu')} src={data.imgSrc.NEWS_YUZU} alt="" loading="lazy" />
                </div>
            </div>
