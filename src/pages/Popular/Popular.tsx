...
import styles from '@/pages/Popular/Popular.module.scss';
...
function Popular() {
    ...
    const { data, fetchNextPage, hasNextPage, isFetchingNextPage, isLoading, isError, error } = useMostPopular();
    ...
    return (
        <div className={cx('popularWrapper')}>
            <div className={cx('popularContainer')}>
                <header className={cx('popularContainer__header')}>
                    <div className={cx('popularContainer__header__title')}>
                        <h3>Most Popular Anime</h3>
                    </div>
                    <div className={cx('popularContainer__header__actions')}>
                        {/* Browse Button */}
                        <button
                            ref={browseRef}
                            className={cx('popularContainer__header__actions__btn', {
                        ...
                        >
                            ...
                            <span className={cx('popularContainer__header__actions__btn__title')}>Popular</span>
                        ...
                        >
                            ...
                            <span className={cx('popularContainer__header__actions__btn__title')}>Filter</span>
                ...
                {(filters.language !== 'all' || filters.media !== 'all') && (
                    <div className={cx('popularContainer__filter')}>
                        <Button contentStart onClick={resetFilters}>
                            <div className={cx('popularContainer__filter__btn')}>
                                <h4 className={cx('popularContainer__filter__btn__title')}>Reset Filters:</h4>
                                <span className={cx('popularContainer__filter__btn__title')}>{filters.language}</span>
                                <span className={cx('popularContainer__filter__btn__title')}>{filters.media}</span>
                            </div>
                        </Button>
                    </div>
                )}
